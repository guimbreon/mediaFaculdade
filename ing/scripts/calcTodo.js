...
function constCadeira(jsonData, jsonData2){
    ...
    for(let element in jsonData){
        ...
        titSemestre.innerHTML = "Semester"
    ...
    titMedia.innerHTML = "Median Grade"
...
function readMaisAvals(){
    ...
    if(correctTypes){
        ...
        alert("(FILLING ALL FIELDS IS MANDATORY!) You are entering the data incorrectly!\nThey should be as follows\n\nYear: Number\nSemester: Number\nName: Letters (with numbers if necessary)\nECTS: Number\nGrade: Number")
    }
    maisForm.reset();
